  ...
  return (
    <section className="mx-auto max-w-7xl px-8 py-32 min-h-[80vh] flex items-center justify-center">
      <div className="w-full max-w-5xl">
        <div className="border-2 border-gray-300 p-16 text-center">
          <p className="text-sm font-medium uppercase tracking-widest text-zinc-600 mb-6">
            Fullstack Developer
          </p>
          <h1 className="text-6xl md:text-7xl font-bold uppercase tracking-tight text-zinc-900 mb-4">
            Building Systems
          </h1>
          <h2 className="text-6xl md:text-7xl font-bold uppercase tracking-tight text-zinc-900 mb-8">
